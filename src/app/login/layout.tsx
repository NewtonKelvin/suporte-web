  ...
  return (
    <Grid container className="h-full w-full">
      <Grid
        ...
        sm={12}
        md={6}
        className="w-float h-float rounded-md py-4 px-16 bg-neutral-900 flex flex-col"
      >
        {children}
      </Grid>
      <Grid
        ...
        sm={12}
        md={6}
        className="w-float h-float rounded-md py-4 px-16 hidden md:flex flex-col text-justify justify-center my-auto"
      >
        <p>
